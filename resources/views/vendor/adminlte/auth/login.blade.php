...
@section('auth_body')
    <div class="row">
        <div class="col-12 col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <img id="logo-login" src="{{ asset('administrativo/arquivos/Admin.png') }}" alt="">
        </div>
        ...
        <div  class="col-12 col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <form action="{{ $login_url }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <button type=submit  class="btn btn-info"  {{ config('adminlte.classes_auth_btn', 'btn-flat btn-info') }}">
